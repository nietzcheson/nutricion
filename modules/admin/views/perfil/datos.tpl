<ul class="nav nav-tabs">
  <li class="active"><a href="{$_layoutParams.root}admin/perfil/datos/{$id}">Datos personales</a></li>
...
<form role="form" method="POST" action="">
  ...
  <div class="form-group col-md-12">
    ...
    <select class="form-control input-lg" name="tipoPerfil" id="tipoPerfil">
      ...
      {if isset($tipos_perfil) && count($tipos_perfil)}
        ...
        <option value="{$tipo.id}" {if isset($datos.id_tipoperfil)}{if $tipo.id== $datos.id_tipoperfil}selected{/if}{/if}>{$tipo.tipo}</option>
        {/foreach}
      {/if}
    </select>
  </div>
  <div class="form-group col-md-12" id="wrapEmpresas" {if $datos.id_tipoperfil==2}style="display:block"{else}style="display:none"{/if}>
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control input-lg" id="nombres" placeholder="Apellido(s)" name="apellidos" value="{if isset($datos.apellidos)}{$datos.apellidos}{/if}">
  </div>
  <div class="form-group col-md-12">
  ...
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control input-lg" id="telefonoTrabajo" placeholder="Teléfono trabajo" name="telefonoTrabajo" value="{if isset($datos.telefono_trabajo)}{$datos.telefono_trabajo}{/if}">
  </div>
  <div class="form-group col-md-4">
    <label for="telefonoCasa">Teléfono casa</label>
    <input type="text" class="form-control input-lg" id="telefonoCasa" placeholder="Teléfono casa" name="telefonoCasa" value="{if isset($datos.telefono_casa)}{$datos.telefono_casa}{/if}">
  </div>
  <div class="form-group col-md-4">
    <label for="telefonoCelular">Teléfono celular</label>
    <input type="text" class="form-control input-lg" id="telefonoCelular" placeholder="Teléfono celular" name="telefonoCelular" value="{if isset($datos.telefono_celular)}{$datos.telefono_celular}{/if}">
  </div>
  <div class="form-group col-md-4">
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control input-lg datepicker" id="fecha_nacimiento" placeholder="Fecha de nacimiento" name="fecha_nacimiento" value="{if isset($datos.fecha_nacimiento)}{$datos.fecha_nacimiento}{/if}">
  </div>
  <div class="form-group col-md-6">
